 ...
 * handelling name collection, adding seating on Extras page, booking and lastly cancelling booking on MyPage
 */
describe('Charter Flight: Mallorca ', () => {
  ...
  describe('Initialize Bookingstart', () => {
    it('Can open start page', function() {
      ...
      browser.sessionStorage('POST', {
        key: 'DT_TESTNAME',
        value: '*** webdriverio *** Charter Flight with Seating - mocha',
      });
  ...
  describe('Select flight in Flight list', () => {
    it('Wait until Flight list is found', () => {
      CharterFlights.waitForPageToLoad(10000);
    });
  ...
  HandleExtras(sharedData, { seating: { enable: true, adults: 2 } });
