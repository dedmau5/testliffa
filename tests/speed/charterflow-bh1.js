...
describe('Speedtest for charterflow with bookinghub2 api', () => {
  const selectors = {
    url: 'https://www.ving.se/boka-resa?QueryDepID=2788&QueryCtryID=65&QueryAreaID=108&QueryResID=0&QueryDepDate=20180606&QueryDur=15&CategoryId=2&QueryRoomAges=%7C42%2C42&QueryUnits=1&selectedTransport=vits%7CCgJWUxIDQVJOGgNMUEEgDyoECMyUAjICMzE6AUU%3D', // eslint-disable-line max-len
  };

  before(() => {
    StartPage.open();
    browser.sessionStorage('POST', { key: 'DT_TESTNAME', value: 'TEAM1: Charterflow with bookinghub1' });
