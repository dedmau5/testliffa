...
const urlFirst = 'https://www.ving.se/boka-resa?QueryDepID=2788&QueryCtryID=65&QueryAreaID=108&QueryResID=0&QueryDepDate=';
...
describe('Tests to load Charterflow with bh1', () => {
  it('Should perform BH2 searches', () => {
    for (let x = startOffset; x < startOffset + iterations; x += 1) {
      StartPage.open();
      browser.windowHandleFullscreen();
      browser.sessionStorage('POST', { key: 'DT_TESTNAME', value: 'TEAM1: Speed test Charterflow BH1' });
      browser.sessionStorage('POST', { key: 'DT_TESTRUNID', value: 'speed_charterflow_bh1' });
