  ...
  it('Opening my page', () => {
    ...
    for (let x = 0; x < iterations; x += 1) {
      try {
        ...
        browser.sessionStorage('POST', { key: 'DT_TESTNAME', value: 'TEAM1: Speed test for new My page with one cp' });
        browser.sessionStorage('POST', { key: 'DT_TESTRUNID', value: 'speed_mypage_new_one_trip' });
