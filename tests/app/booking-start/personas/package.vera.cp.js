...
exports.PackageVeraCP = {
  ...
  departure: translate({
    dk: 'København', fi: 'Helsinki', no: 'Oslo, Gardermoen', se: 'Stockholm-Arlanda',
  }),
  destination: {
    country: translate({
      dk: 'Thailand', fi: 'Espanja', no: 'Spania', se: 'Spanien',
    }),
    area: translate({
      dk: 'Phuket', fi: 'Gran Canaria', no: 'Gran Canaria', se: 'Gran Canaria',
    }),
    resort: translate({
      dk: 'Alle rejsemål', fi: 'Las Palmas', no: 'Las Palmas', se: 'Las Palmas',
    }),
  },
  duration: {
    visible: true,
    lenght: translate({
      dk: '1 uge', fi: '2 viikkoa', no: '1 uke', se: '1 vecka',
    }),
  },
  date: {
    departure: {
